...
class User:
    ...
    def __hash_password(self, password):
        # Simulate password hashing (replace with real hashing in production)
...
# Lock the account if wrong
user.authenticate("wrong1")
user.authenticate("wrong2")
user.authenticate("wrong3")  # This is the 3rd failed attempt, account will lock

print("User safe info:", user.get_safe_info())